PROJECT_ID=engaged-kite-319901
ZONE=us-central1-a
...
SSH_STRING=chris@storybooks-vm-$(ENV)
...
deploy: check-env
	...
	@$(MAKE) ssh-cmd CMD='\
		docker run -d --name=$(CONTAINER_NAME) \
			...
			-p 80:3000 \
			-e PORT=3000 \
			-e \"MONGO_URI=mongodb+srv://storybooks-user-$(ENV):$(call get-secret,atlas_user_password_$(ENV))@storybooks-$(ENV).yn98g.mongodb.net/$(DB_NAME)?retryWrites=true&w=majority\" \
			-e GOOGLE_CLIENT_ID=677674907093-ig0f1i3lfvjndgm9t9uv5dvsocsqa1v7.apps.googleusercontent.com \
